...
import introImg from '../../assets/Home/h5.jpg'; // Construction site image
            ...
            <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
                    ...
                    <div className="lg:col-span-7 flex flex-col justify-center order-2 lg:order-1">
                        ...
                        {/* Overline */}
                        <span className="text-[13px] text-gray-500 tracking-[0.15em] uppercase mb-3 font-semibold font-['Necto_Mono',ui-monospace]">
                            Genesis Contracting
                        </span>

                        {/* Title */}
                        <h2 className="font-['Apfel_Grotezk',ui-sans-serif,system-ui,sans-serif,'Apple_Color_Emoji','Segoe_UI_Emoji','Segoe_UI_Symbol','Noto_Color_Emoji'] text-[36px] md:text-[52px] font-normal text-[#2A3A4A] leading-[1.15] tracking-tight mb-6">
                            Industry leaders of alternative fueling systems
                        </h2>

                        {/* Red Accent Divider */}
                        <div className="w-10 h-1.5 bg-[#DA291C] mb-8"></div>
                        ...
                        <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6 border-t border-gray-100 pt-8">
                            ...
                            <div className="shrink-0 w-24 h-24 relative flex items-center justify-center">
                                <svg viewBox="0 0 100 100" className="w-full h-full animate-spin-slow">
                                    {/* Green Loop Part */}
                                    <path d="M 50 15 A 35 35 0 0 1 85 50 A 35 35 0 0 1 80 62 L 67 52 A 19 19 0 0 0 71 50 A 19 19 0 0 0 50 29 Z" fill="#1ba345" />
                                    {/* Blue Loop Part */}
                                    <path d="M 15 50 A 35 35 0 0 1 50 15 L 50 29 A 19 19 0 0 0 29 50 A 19 19 0 0 0 38 62 L 23 72 A 35 35 0 0 1 15 50 Z" fill="#025ba6" />
                                    {/* Yellow Loop Part */}
                                    <path d="M 80 62 A 35 35 0 0 1 50 85 A 35 35 0 0 1 23 72 L 38 62 A 19 19 0 0 0 50 71 A 19 19 0 0 0 67 52 Z" fill="#fab900" />
                                </svg>
                            </div>

                            {/* Mission copy */}
                            <div className="flex-1 text-center sm:text-left">
                                <h3 className="font-['Necto_Mono',ui-monospace] text-[#DA291C] font-semibold text-[18px] md:text-[20px] uppercase tracking-wider mb-2">
                                    Our Mission
                                </h3>
                    ...
                    <div className="lg:col-span-5 w-full h-[400px] lg:h-[550px] order-1 lg:order-2">
                        <div className="relative w-full h-full rounded-xl overflow-hidden shadow-lg group border border-gray-100">
                            {/* Subtle Brand Red Graphic Corner Accent */}
                            <div className="absolute top-0 left-0 w-8 h-full bg-[#DA291C] -skew-x-12 -translate-x-4 z-10"></div>
