...
import { CheckCircle2, Building2, Zap, Wrench } from 'lucide-react';
...
const cardsData = [
    ...
    },
    {
        ...
        items: [
            ...
            "Equipment and Safety Maintenance",
            "CP & Hydrogen Skid Troubleshooting"
        ]
    }
];

const HydrogenThreeGrid = () => {
    return (
            ...
            <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12">
                <div className="text-center max-w-3xl mx-auto mb-16">
                    ...
                    <h2 className="font-['Apfel_Grotezk',ui-sans-serif,system-ui,sans-serif,'Apple_Color_Emoji','Segoe_UI_Emoji','Segoe_UI_Symbol','Noto_Color_Emoji'] text-[36px] md:text-[48px] font-normal text-[#2A3A4A] leading-[1.1] tracking-tight">
                        Fueling Station Infrastructure Capabilities
                    </h2>
...
export default HydrogenThreeGrid;
