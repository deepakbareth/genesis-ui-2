...
const industries = [
    { name: "Hydrogen Infrastructure integrators", icon: <Layers className="w-5 h-5 text-red-700" /> },
    ...
    { name: "Public Transit Buses Operators", icon: <Bus className="w-5 h-5 text-red-700" /> },
    { name: "Municipal and government fleets", icon: <Building2 className="w-5 h-5 text-red-700" /> },
