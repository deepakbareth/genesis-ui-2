        ...
        >
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 w-full">
                ...
                <div className="flex flex-wrap items-center gap-x-4 gap-y-2 md:gap-6 text-white/80 text-[14px] md:text-[20px] mb-8 md:mb-[50px] font-semibold font-['Necto_Mono',ui-monospace,SFMono-Regular,Menlo,Monaco,Consolas,'Liberation_Mono','Courier_New',monospace] tracking-wide">
                    <a href="#hydrogen" className="hover:text-white transition-colors underline whitespace-nowrap">Hydrogen</a>
                    <a href="#ev-charging" className="hover:text-white transition-colors underline whitespace-nowrap">EV Charging</a>
                    <a href="#cng" className="hover:text-white transition-colors underline whitespace-nowrap">CNG</a>
                    <a href="#civil" className="hover:text-white transition-colors underline whitespace-nowrap">Civil</a>
                    <a href="#electrical" className="hover:text-white transition-colors underline whitespace-nowrap">Electrical</a>
                    <a href="#maintenance" className="hover:text-white transition-colors underline whitespace-nowrap">Maintenance</a>
                    <a href="#upgrades" className="hover:text-white transition-colors underline whitespace-nowrap">Upgrades</a>
                </div>
