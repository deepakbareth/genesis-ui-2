...
const footerData = {
    ...
    services: [
        { label: "Hydrogen Division", url: "/genesis-ui-2/services/hydrogen" },
        { label: "CNG & LNG Division", url: "/genesis-ui-2/services/cng" },
        { label: "EV Division", url: "/genesis-ui-2/services/ev" },
        { label: "Civil & Concrete", url: "/genesis-ui-2/services#civil" },
        { label: "Electrical", url: "/genesis-ui-2/services#electrical" }
    ],
...
const Footer = () => {
    return (
        <footer className="relative w-full bg-[#1A2230] text-gray-300 py-10 font-sans overflow-hidden">
            ...
            <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 mb-16">
                    ...
                    <div className="lg:col-span-4 flex flex-col items-start gap-4">
                        <a href="/genesis-ui-2/" className="block">
                            <img
                                src={logo}
                                alt="Genesis Contracting logo"
                                className="h-16 w-auto drop-shadow-[0_0px_8px_rgba(0,0,0,0.5)]"
                            />
                        </a>
                        <p className="text-[14px] text-gray-400 mt-2 max-w-sm leading-relaxed">
                            Building high-performance fueling infrastructure and establishing trusting, long-term relationships across the United States since 1998.
                        </p>
                    </div>

                    {/* RIGHT COLUMN: Menus and Contact details */}
                    <div className="lg:col-span-8 grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8">

                        {/* Sub-column 1: Contact */}
                        <div className="flex flex-col">
                            ...
                            <div className="flex flex-col gap-5">
                                ...
                                <a href={`mailto:${footerData.contact.email}`} className="flex items-center gap-3 hover:text-white transition-colors group">
                                    <svg className="w-5 h-5 text-red-500 group-hover:text-red-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                ...
                <div className="pt-8 border-t border-gray-700/60 flex flex-col sm:flex-row items-center justify-between gap-4 text-center sm:text-left">
                    ...
                    <div className="flex items-center gap-2">
                        <a
                            ...
                            className="flex items-center gap-2 text-[13px] text-gray-400 hover:text-white transition-colors group"
                        >
                            <span>Powered by</span>
                            <img
                                src={pbw}
                                alt="Premium Business Websites Logo"
